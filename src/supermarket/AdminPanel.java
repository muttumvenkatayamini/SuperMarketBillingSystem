...
public class AdminPanel extends JFrame {
  ...
  public AdminPanel() {
    ...
    tabbedPane.addTab("Cashier", null, customerPanel, null);
    ...
    JButton btnAddCustomer = new JButton("Add Cashier");
    ...
    btnAddCustomer.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        try {
          ...
          JOptionPane.showMessageDialog(btnAddCustomer, "Can't Add Cashier");
          e1.printStackTrace();
        }
      }
    });
